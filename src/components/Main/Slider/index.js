            ...
            <section className="slide1">
                <div className="wrap-slick1">
                    <div className="slick1">
                        <div className="item-slick1 item1-slick1" style={{ backgroundImage: 'url(https://colorlib.com/etc/fashe/images/master-slide-02.jpg)' }}>
                        ...
                        <div className="item-slick1 item2-slick1" style={{ backgroundImage: 'url(https://colorlib.com/etc/fashe/images/master-slide-03.jpg)' }}>
                            <div className="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                        ...
                        <div className="item-slick1 item3-slick1" style={{ backgroundImage: 'url(https://colorlib.com/etc/fashe/images/master-slide-04.jpg)' }}>
                            <div className="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
